...
/***/ function(module, exports, __webpack_require__) {
	...
	function fixImage(data) {
		var distMaxWidth = 1280;
		var scale  = 1;
		var image  = new Image();
		image.src  = data;
		...
		if (distMaxWidth < width) {
			scale = distMaxWidth / width;
		}

		var canvas = document.createElement("canvas");
		canvas.width = width * scale;
		canvas.height = height * scale;
		canvas.getContext("2d").drawImage(image, 0, 0, width * scale, height * scale);
		...
		onload = function() {
			document.getElementById("upfile").addEventListener("change", function(e) {
				...
				reader.onload = function() {
					...
					distImageUrl = fixImage(imageDataUrl);
					document.getElementById("jpg-dl").href = distImageUrl;
					document.getElementById("jpg-dl").download = getGenerateDate();
					$("#jpg-dl").removeClass("uk-hidden");
				};
			});
		};
	}());
